...
poem = list(input("Enter a Winnie the Pooh's rhyme: ").split())
print(poem)

vowels = ("а","у","е","о","и","ю","э","я","ё","ы")

print(f"Парам пам-пам" if len(set(sum(letter in vowels for letter in word) for word in poem)) == 1 
      else "Пам парам")
